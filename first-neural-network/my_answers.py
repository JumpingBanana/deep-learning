...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error = output_error_term*np.identity(self.weights_hidden_to_output.shape[0])*self.weights_hidden_to_output
        
        # TODO: Backpropagated error terms - Replace these values with your calculations.
        hidden_gradient = hidden_outputs*(1 - hidden_outputs)
        hidden_error_term = np.dot(hidden_error,hidden_gradient.T)
